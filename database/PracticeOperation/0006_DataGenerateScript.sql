...
go
--
insert into Appointment (CheckInDate, MedicalConcerns, Status, PatientID) 
						values 
...
go
--
insert into Contact (PhoneNumber, Email, PatientID) 
					values
...
go
--
insert into Address (TypeAddress, Address, IsPrimary, ContactID)
					values
...
go
--
insert into EmergencyContact (Relationship, Name, PhoneNumber,ContactID)
							values 
